if __name__ == '__main__':
    ...
    save_path = pathlib.Path(f"16_dim_ReverseIAF_mix_epochs{epochs}_flowsteps{n_flow_steps}_dist{n_distributions}")
    ...
    learnt_sampler = FlowModel(x_dim=dim, scaling_factor=2.0, flow_type="ReverseIAF_MIX", n_flow_steps=n_flow_steps,
                               nodes_per_x=1.5)
